        ...
        <a-form layout="vertical">
            ...
            <template v-if="currentStep == 0">
                ...
                <a-row :gutter="16">
                    ...
                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                        <a-form-item
                            :label="$t('campaign.lead_distribution_method')"
                            name="lead_distribution_method"
                            :help="
                                rules.lead_distribution_method
                                    ? rules.lead_distribution_method.message
                                    : null
                            "
                            :validateStatus="
                                rules.lead_distribution_method ? 'error' : null
                            "
                        >
                            <a-select
                                v-model:value="formData.lead_distribution_method"
                                :placeholder="
                                    $t('common.select_default_text', [
